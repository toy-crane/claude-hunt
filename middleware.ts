...
/**
 * Root middleware: refreshes the Supabase session and gates authed
 * users without a cohort to /onboarding. Static assets, Next.js
 * internals, and image files are excluded at the matcher level so this
 * function body never runs for them — no DB round-trip cost.
 */
 ...
 * favicon so the middleware body never runs for them — preventing
