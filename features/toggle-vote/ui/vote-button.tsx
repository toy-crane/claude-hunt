...
export function VoteButton({
  ...
  if (ownedByViewer) {
    return (
      <div
        className="inline-flex min-w-14 flex-col items-center justify-center gap-0.5 rounded-md border border-transparent px-2 py-2 font-semibold text-muted-foreground text-sm leading-none"
