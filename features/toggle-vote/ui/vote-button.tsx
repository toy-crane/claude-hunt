...
const STACKED_BASE_CLASS =
  "inline-flex flex-col items-center justify-center min-w-14 gap-0.5 rounded-md border px-2 py-2 text-sm font-semibold leading-none outline-none transition duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] active:scale-[0.97] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none";
