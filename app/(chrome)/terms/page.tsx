  ...
  return (
    <main className="mx-auto flex min-h-svh w-full max-w-3xl flex-col gap-8 p-6">
      <header className="flex flex-col gap-2">
        <h1 className="font-semibold text-2xl">서비스 이용약관</h1>
        <p className="text-muted-foreground text-sm">시행일: 2026년 6월 1일</p>
      </header>

      <nav aria-label="목차" className="rounded-md border p-4">
        <h2 className="mb-3 font-medium text-muted-foreground text-xs">목차</h2>
      ...
      <article className="flex flex-col gap-8 text-sm leading-relaxed">
        ...
        <section aria-labelledby="t-12" className="flex flex-col gap-2">
          ...
          <p>
            ...
            해지(회원 탈퇴)할 수 있습니다. 탈퇴 즉시 회원의 개인정보와 게시물은
            개인정보 처리방침에 따라 파기됩니다.
          </p>
        </section>
